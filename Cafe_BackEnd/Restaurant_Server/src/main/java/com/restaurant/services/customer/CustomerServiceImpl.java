...
public class CustomerServiceImpl implements CustomerService {
    ...
    public CustomerServiceImpl(UserRepo userRepo, CategoryRepo categoryRepo, ProductRepo productRepo,
			TableReservationRepo tableReservationRepo) {
		super();
		this.userRepo = userRepo;
		this.categoryRepo = categoryRepo;
		this.productRepo = productRepo;
		this.tableReservationRepo = tableReservationRepo;
	}
